<template>
	<div class="main" >
    <mt-header fixed class="bgtransparent" title="业主委托">
      <a href="JavaScript:history.back(-1)" slot="left">
        <mt-button icon="back"></mt-button>
      </a>
    </mt-header>
    <div class="content-top"><img src="../../../static/skin/images/yezhutop.jpg"/> </div>
    <div class="content">
      <div class="formcont">
        <label>写字楼信息+联系人信息</label>
        <textarea v-model="requirements" placeholder="您可以填写楼盘名称、出租面积记忆地址等相关信息"></textarea>
        ...
        <input type="button" name="" value="提交"  @click="submitLogin()"/>
        <a @click="countdown"  :disabled="smsDis">{{smsBtnText}}</a>
      </div>
      <div class="contentbuttom">
        <img src="../../../static/skin/images/yezhu.jpg" />
      </div>
		</div>
	</div>
</template>
...
<style>
  ...
  .content-top img{width: 100%;height: auto;}
